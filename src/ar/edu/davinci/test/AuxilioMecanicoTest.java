...
public class AuxilioMecanicoTest {
	...
	public static void main(String[] args) {
		...
		CamionAuxilioService camioneAuxilioService = new CamionAuxilioService();
		...
		clienteService.reportarProblema("456", "def", "Rompi", TipoReparacion.REPARACION_SIMPLE, 5.0, 5.0);
